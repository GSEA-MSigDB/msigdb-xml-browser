...
import edu.mit.broad.msigdb_browser.genome.parsers.*;
import edu.mit.broad.msigdb_browser.vdb.chip.*;
import edu.mit.broad.msigdb_browser.vdb.map.Chip2ChipMapperSymbol;
import edu.mit.broad.msigdb_browser.vdb.meg.*;
...
public class VdbRuntimeResources {
    ...
    public static AliasDb getAliasDb() throws Exception {
        ...
        if (kAliasDb == null) {
            kAliasDb = new AliasDbImpl(getChip_Gene_Symbol());
        }
    ...
    // seq accessions is a special chip: accesions + symbols + aliases
    // see ChipParser
    ...
    public static Chip2ChipMapperSymbol getGeneSymbolMapper(final Chip chip) throws Exception {
        return new Chip2ChipMapperSymbol(getChip_Gene_Symbol(), chip);
    }

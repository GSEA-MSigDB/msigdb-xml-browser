...
import edu.mit.broad.msigdb_browser.xbench.explorer.filemgr.*;
...
public class FileManagerImpl implements FileManager {
    ...
    private XDirChooser fDirChooser;
    ...
    static class ListCellRenderer extends RendererFactory2.CommonLookListRenderer {
        Map map;
        ...
        public Component getListCellRendererComponent(JList list,
            ...
            if (map.containsKey(value.toString())) {
                DescriptedFile df = (DescriptedFile) map.get(value.toString());
                this.setText(df.file.getPath() + "  ---->[" + df.desc + "]");
                this.setIcon(ICON);

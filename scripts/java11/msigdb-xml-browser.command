...
exec java --module-path="$prefix"/modules -Xmx4g \
    ...
    --add-exports=jide.common/com.jidesoft.grid=org.gsea-msigdb.msigdb-xml-browser --add-exports=jide.common/com.jidesoft.docking=org.gsea-msigdb.msigdb-xml-browser --add-exports=jide.common/com.jidesoft.status=org.gsea-msigdb.msigdb-xml-browser \
